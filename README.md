...
En este app vamos a utilizar `react-router` para poder tener más de una ruta en nuestra **SPA**.
Tenemos tres rutas que podremos navegar:
 - **"/"**: El home.
 ...
 - **"/about"**: Espacio para información adicional a la web app.
...
En éste proyecto se mostrará lo siguiente:
